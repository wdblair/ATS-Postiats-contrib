...
//
val () = insert("sgn_real", S2CINTbuiltin_1(formula_isgn))
val () = insert("neg_real", S2CINTbuiltin_1(formula_ineg))
val () = insert("int2real",  S2CINTbuiltin_1(formula_identity)) // smt-lib doesn't care
val () = insert("sqrt_real",  S2CINTbuiltin_1(formula_isqrt))
val () = insert("gte_real_real", S2CINTbuiltin_2(formula_igte))
val () = insert("lt_real_real", S2CINTbuiltin_2(formula_ilt))
val () = insert("gt_real_real", S2CINTbuiltin_2(formula_igt))
val () = insert("eq_real_real", S2CINTbuiltin_2(formula_ieq))
val () = insert("lte_real_real", S2CINTbuiltin_2(formula_ilte))
val () = insert("add_real_real", S2CINTbuiltin_2(formula_iadd))
val () = insert("sub_real_real", S2CINTbuiltin_2(formula_isub))
val () = insert("mul_real_real", S2CINTbuiltin_2(formula_imul))
val () = insert("div_real_real", S2CINTbuiltin_2(formula_rdiv))
val () = insert("pow_real_real", S2CINTbuiltin_2(formula_ipow))
//
//
...
//
val () = insert("sgn_float", S2CINTbuiltin_1(formula_fpsgn))
...
val () = insert("bag_sub", S2CINTbuiltin_2(formula_bag_subset))
...
val () = insert("set_sub", S2CINTbuiltin_2(formula_set_sub))
